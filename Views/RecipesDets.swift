...
//  tesanna
//
//  Created by Kady Alyahya on 20/05/1445 AH.
//
...
//                            .overlay(
//                                Text("٤ اشخاص")
////                                    .font(.custom("SF Arabic Rounded-Bold", size: 18))
//                                    .foregroundColor(.black)
...
//
//                        Text("برياني دجاج")
//                         /*   .font(.custom("SF Arabic Rounded-Bold", size: 24)*//*)*/
//                            .bold()
//                            .padding()
//
//                        HStack {
...
//                            VStack {
//                                Text(item)
////                                    .font(.custom("SF Arabic Rounded-Regular", size: 18))
